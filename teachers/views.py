...
def importer(request):
    ...
    if request.method == 'POST':
        ...
        if import_form.is_valid():
            ...
            csv_file_name = import_form.cleaned_data.get('csv_file')
            new_file = request.FILES['csv_file'].read().decode('utf-8')
            ...
            csv_data = csv.DictReader(StringIO(new_file), delimiter=',')
            for row in csv_data:
    ...
    return render(request, 'teachers/importer.html', {'import_form': import_form})
